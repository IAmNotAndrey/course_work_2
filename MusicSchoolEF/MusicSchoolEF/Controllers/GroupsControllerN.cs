...
{
    public class GroupsControllerN : Controller
    {
        private readonly Ms2Context _context;

        public GroupsControllerN(Ms2Context context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(uint id, [Bind("Name,Id")] Group @group)
        {
            if (id != @group.Id)
            {
                return NotFound();
